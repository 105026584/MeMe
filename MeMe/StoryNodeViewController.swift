...
class StoryNodeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
            ...
            // Next Node depending on the selected choice
            let nextNodeInTheAdventure = storyNode.storyNodeForIndex(indexPath.item)
        ...
        func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
            ...
            cell.textLabel!.text = storyNode.promptForIndex(indexPath.item)
